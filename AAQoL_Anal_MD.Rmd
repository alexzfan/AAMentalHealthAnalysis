...
The second reason seems more likely for two reasons. First, after running a few chi-square tests, which tell us whether there is an association between variables, we note that there is a statistical significance between feeling shame about depression and receiving treatment for 
```{r}
...
prop.table(table(df$Shame, df$Counseling), margin = 1)
```
